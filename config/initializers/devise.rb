...
Devise.setup do |config|
  ...
  config.secret_key = Rails.env.production? ? ENV['DEVISE_SECRET_KEY'] : 'development'
  ...
  # config.pepper = '746f96bfca1a1641fad91cb4e5f25957643ef6a894330dee085979823e8d1eec1882f48545623f712f80a1fdd3b9f58a3806be38604d79526bae24ad75f8da5e'
  ...
  config.omniauth :openid_connect, name: 'arcdata', scope: ['openid', 'profile', 'vc_profile', 'deployments'], client_options: {
    ...
    token_endpoint: '/openid/access_tokens',
    userinfo_endpoint: '/openid/user_info'#,
    #redirect_uri: 'http://localhost:3010/users/auth/arcdata/callback'
  }
end
